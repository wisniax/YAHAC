...
namespace YAHAC.MVVM.ViewModel
{
    public class DebugDataViewModel : ObservableObject
    {
        ...
        {
            get { return (_BazaarAge == null || double.Parse(_BazaarAge, CultureInfo.InvariantCulture) > 999) ? "NaN" : _BazaarAge; }
            set
            {
                _BazaarAge = value;
                OnPropertyChanged();
        ...
        {
            get { return _AuctionHouseAge == null || double.Parse(_AuctionHouseAge, CultureInfo.InvariantCulture) > 999 ? "NaN" : _AuctionHouseAge; ; }
            set
            {
